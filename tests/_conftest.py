...
from pytest_homeassistant_custom_component.common import QualityScaleStatus, get_quality_scale

# if TYPE_CHECKING:
#     from homeassistant.components.hassio import AddonManager
    
#     from pytest_homeassistant_custom_component.components.conversation import MockAgent
#     from pytest_homeassistant_custom_component.components.device_tracker.common import MockScanner
#     from pytest_homeassistant_custom_component.components.light.common import MockLight
#     from pytest_homeassistant_custom_component.components.sensor.common import MockSensor
#     from pytest_homeassistant_custom_component.components.switch.common import MockSwitch
